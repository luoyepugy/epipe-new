+(function($){
	...
	// Linkage.prototype.setContent = function () {
	// 	var $tip    = this.tip()
	// 	var tab   = this.getTab()
	// 	var content = this.getContent()

	// 	$tip.find('.linkage-tab')[this.options.html ? 'html' : 'text'](tab)
	// 	$tip.find('.linkage-content').children().detach().end()[ // we use append for html objects to maintain js events
	// 	  this.options.html ? (typeof content == 'string' ? 'html' : 'append') : 'text'
	// 	](content)

	// 	$tip.find('linkage').removeClass('active')

	// 	// IE8 doesn't accept hiding via the `:empty` pseudo selector, we have to do
	// 	// this manually by checking the contents.
	// 	if (!$tip.find('.linkage-tab').html()) $tip.find('.linkage-tab').hide()
	// }
	// Linkage.prototype.getContent = function (){
	// 	var i , len, html, value;
	// 	for(i =0 , len = this.options.url.length; i < len ; i++){
	// 		formatted=this.options.formatResult(this.options.url[i])
	// 		html += '<li data-index='+i+' data-value='+formatted.value+'>'+formatted.template+'</li>'
	// 	}
	// 	return '<ul>'+html+'</ul>'
	// }
	// Linkage.prototype.getTab = function () {
	// 	var html = this.options.formatTab(this.options.url[0].p)
	// 	return '<ul class="nav nav-tabs">'+html+'</ul>'
	// }
	
	// Linkage.prototype.toggle = function (e) {
 //    var self = this
 //    if (e) {
 ...
 //  }
	...
	// Linkage.prototype.getData = function () {
...
// 		var box_obj=this,
// 				input_obj=box_obj.find(".j-input"),

// 				$linkageContentList=box_obj.find(".linkage-content>div"),
// 				prov_obj=$linkageContentList.eq(0),
// 				city_obj=$linkageContentList.eq(1),
// 				dist_obj=$linkageContentList.eq(2),

// 				$linkageTablist = box_obj.find('.linkage-tab li'),
// 				prov_wrap_obj=$linkageTablist.eq(0).find('a'),
// 				city_wrap_obj=$linkageTablist.eq(1).find('a'),
// 				dist_wrap_obj=$linkageTablist.eq(2).find('a'),
// 				prov_value_obj=$linkageTablist.eq(0).find('.value'),
// 				city_value_obj=$linkageTablist.eq(1).find('.value'),
// 				dist_value_obj=$linkageTablist.eq(2).find('.value'),
...
// 			var prov_id=index ? index : prov_obj.find("li:first-child").attr("data-index");

// 			if(prov_id<0||typeof(settings.url[prov_id].c)=="undefined") return
			
// 			// 遍历赋值市级下拉列表
// 			// temp_html=select_prehtml;
// 			var temp_html="";
// 			$.each(settings.url[prov_id].c,function(i,city){
// 				temp_html+="<li data-index='"+i+"' data-value='"+city.n+"'>"+city.n+"</li>";
// 			});
// 			city_obj.html("<ul class='area-list'>"+temp_html+"</ul>");
// 			distStart();
// 		};
// 		// 赋值地区（县）函数
// 		var distStart=function(){
// 			var prov_id=prov_obj.find("li:first-child").attr("data-index");
// 			var city_id=city_obj.find("li:first-child").attr("data-index");
...
// 			if(prov_id<0||city_id<0||typeof(settings.url[prov_id].c[city_id].a)=="undefined"){
...
// 			// temp_html=select_prehtml;
// 			temp_html=" ";
// 			$.each(settings.url[prov_id].c[city_id].a,function(i,dist){
// 				temp_html+="<li data-index='"+i+"' data-value='"+dist.s+"'>"+dist.s+"</li>";
// 			});
// 			dist_obj.html("<ul class='area-list'>"+temp_html+"</ul>");
// 		};

// 		var init=function(){
// 			// 遍历赋值省份下拉列表
// 			temp_html=" ";
// 			$.each(settings.url,function(i,prov){
// 				temp_html+="<li data-index='"+i+"' data-value='"+prov.p+"'>"+prov.p+"</li>";
// 			});
// 			prov_value_obj.html(settings.url[0].p);
// 			city_value_obj.html(settings.url[0].c[0].n);
// 			prov_obj.html("<ul class='area-list'>"+temp_html+"</ul>");

// 			// 若有传入省份与市级的值，则选中。（setTimeout为兼容IE6而设置）
// 			// setTimeout(function(){
// 			// 	if(settings.prov!=null){
// 			// 		// prov_obj.val(settings.prov);
// 			// 		prov_value_obj.html(settings.prov);
// 			// 		cityStart();
// 			// 		setTimeout(function(){
// 			// 			if(settings.city!=null){
// 			// 				city_value_obj.val(settings.city);
// 			// 				distStart();
// 			// 				setTimeout(function(){
// 			// 					if(settings.dist!=null){
// 			// 						dist_value_obj.val(settings.dist);
// 			// 					};
// 			// 				},1);
// 			// 			};
// 			// 		},1);
...
// 				cityStart();
// 				if(settings.city!=null){
// 					city_value_obj.html(settings.city);
// 					// distStart();
// 					if(settings.dist!=null){
// 						dist_value_obj.html(settings.dist);
// 					};
// 				};
// 			};
// 			// 选择省份时发生事件
// 			prov_obj.on("click",function(e){
// 				var $this = $(e.target),
// 					value = $this.attr("data-value"),
// 					index = $this.attr("data-index");
// 				prov_value_obj.html(value);
// 				// console.log($(e.target)[0].nodeName.toLowerCase() == 'li')
// 				city_value_obj.trigger("click");
// 				city_value_obj.html(settings.url[index].c[0].n);
// 				//dist_value_obj.html(settings.url[index].c[0].a[0].s);
// 				// input_obj.val(value);
// 				cityStart(index);
// 			});

// 			// 选择市级时发生事件
// 			city_obj.on("click",function(e){
// 				var $this = $(e.target),
// 					value = $this.attr("data-value"),
// 					index = $this.attr("data-index");
// 				city_value_obj.html(value);
// 				// input_obj.attr('value',value);
// 				input_obj.val(prov_value_obj.html()+value);
// 				//distStart();
// 				$(".j-linkage.active").removeClass("active");
// 			});
// 		};
// 		input_obj.on("click" , function(e){
// 			e.stopPropagation();
// 			$(this).val("");
// 			prov_value_obj.trigger("click");
// 			$(".j-linkage.active").removeClass("active");
// 			box_obj.find(".j-linkage").addClass("active");
// 		})
// 		$(document).on("click",function(e){

// 			if($(e.target).closest(".j-linkage").length<=0){
// 				$(".j-linkage.active").removeClass("active");				
// 			}
// 		})
// 		// 设置省市json数据
